        ...
        <div className='mth'>
            ...
            <div className='conteudo-pt'>
                ...
                <div className='ct-01'>
                    ...
                    <CabecalhoEx titulo='Exercício 05 - Média Aluno' cor='#cb37ff' desc='Implementar um programa em Javascript para verificar se um aluno passou ou não, baseado em 3 notas, considerando que a média mínima para passar é 6.' />
